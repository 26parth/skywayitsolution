    ...
    // import "../styles/AnimatedHeading.css"; // make sure this path is correct

    // export default function AnimatedHeading({ text = "Explore Courses" }) {
    //   const [invert, setInvert] = useState(false);

    //   useEffect(() => {
    //     // Toggle a class on the body (clean React-friendly way)
    //     document.body.classList.toggle("invert", invert);
    //     // cleanup not required here because toggle sets exact state,
    //     // but you could remove on unmount if you want:
    //     return () => document.body.classList.remove("invert");
    //   }, [invert]);

    //   return (
    //     <div className="heading-wrap" style={{ position: "relative" }}>
    //       <button
    //         onClick={() => setInvert((s) => !s)}
    //         aria-pressed={invert}
    ...
    //         {/* Outline group - converted from your SVG (no HTML comments) */}
    //         <g id="outline">
    ...
    //       {/* visible heading text (for accessibility & fallback) */}
    //       <h2 className="headingText" style={{ marginTop: 10 }}>
    //         {text}
    //       </h2>
    //     </div>
    //   );
